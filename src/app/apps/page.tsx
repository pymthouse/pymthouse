...
function AppsEmptyState() {
  return (
    <div className="text-center py-16 rounded-xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm">
      ...
      <h2 className="text-lg font-medium text-zinc-300 mb-2">No apps yet</h2>
      <p className="text-sm text-zinc-500 mb-6 max-w-sm mx-auto">
        Create your first provider app to configure identity, plans, user management, and signer
        access.
      </p>
      <Link
        href="/apps/new"
...
function AppsPageContent({
  ...
  if (loading) return <AppsLoadingSkeleton />;
    ...
    <DashboardLayout>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">Manage your provider applications</p>
        </div>
        <Link
          href="/apps/new"
