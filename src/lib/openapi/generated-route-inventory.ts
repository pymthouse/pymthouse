...
export const OPENAPI_ROUTE_INVENTORY: ScannedRouteOperation[] = [
  ...
  inventoryOp("get", "/api/v1/apps/{clientId}/customers", "apps/[id]/customers/route.ts"),
  inventoryOp("get", "/api/v1/apps/{clientId}/customers/{externalUserId}", "apps/[id]/customers/[externalUserId]/route.ts"),
