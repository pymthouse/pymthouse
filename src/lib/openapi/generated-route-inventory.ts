...
export const OPENAPI_ROUTE_INVENTORY: ScannedRouteOperation[] = [
  ...
  inventoryOp("delete", "/api/v1/me/billing/payment-method", "me/billing/payment-method/route.ts"),
  ...
  inventoryOp("get", "/api/v1/me/billing/payment-method", "me/billing/payment-method/route.ts"),
  ...
  inventoryOp("get", "/api/v1/turnkey-github-oidc/.well-known/openid-configuration", "turnkey-github-oidc/.well-known/openid-configuration/route.ts"),
  inventoryOp("get", "/api/v1/turnkey-github-oidc/jwks", "turnkey-github-oidc/jwks/route.ts"),
  ...
  inventoryOp("patch", "/api/v1/apps/{clientId}/billing/stripe", "apps/[id]/billing/stripe/route.ts"),
  inventoryOp("patch", "/api/v1/me/billing/payment-method", "me/billing/payment-method/route.ts"),
  ...
  inventoryOp("post", "/api/v1/me/billing/payment-method", "me/billing/payment-method/route.ts"),
