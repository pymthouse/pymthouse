  ...
  assert.equal(
    await resolveAllowsOverageInvoicing({
      ...
      identity: {
        ...
        payerCustomerKey: "owner_user_1",
        payerKind: "platform_user",
        payerPlatformUserId: "owner_user_1",
        isOwner: true,
        ownerUserId: "owner_user_1",
        sharesOwnerCostRail: true,
        actorEndUserId: "owner_user_1",
        actorExternalUserId: "owner_user_1",
  ...
  assert.equal(
    await resolveAllowsOverageInvoicing({
      ...
      identity: {
        ...
        payerCustomerKey: `eu_${externalUserId}`,
        payerKind: "end_user",
        isOwner: false,
        sharesOwnerCostRail: false,
        actorEndUserId: `eu_${externalUserId}`,
        actorExternalUserId: externalUserId,
        legacyCompoundCustomerKey: `${app.clientId}:${externalUserId}`,
  ...
  assert.equal(
    await resolveAllowsOverageInvoicing({
      ...
      identity: {
        ...
        payerCustomerKey: app.userId,
        payerKind: "platform_user",
        payerPlatformUserId: app.userId,
        isOwner: false,
        ownerUserId: app.userId,
        sharesOwnerCostRail: true,
        actorEndUserId: "eu_rollup_id",
        actorExternalUserId: "eu_rollup",
        publicClientId: app.clientId,
        developerAppId: app.clientId,
      },
    }),
