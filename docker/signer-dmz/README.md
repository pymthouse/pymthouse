...
| `pymthouse/signer-dmz:latest` | `Dockerfile` → `signer-dmz` (default) | `livepeer/go-livepeer:sha-9d92ee43300fead9cbcece0867ba04814e3ed218` | **Production** (Railway / Render) and prod smoke tests |
| `pymthouse-signer:local` | `Dockerfile.signer` | `livepeer/go-livepeer:sha-9d92ee43300fead9cbcece0867ba04814e3ed218` | **Livepeer only** (no Apache; not for public deploy) |
