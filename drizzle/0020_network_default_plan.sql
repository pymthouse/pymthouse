...
SELECT
  ...
  'monthly',
  true,
  d."discovery_excluded_capabilities",
...
--> statement-breakpoint
ALTER TABLE "developer_apps" DROP COLUMN IF EXISTS "discovery_allowed_capabilities";

--> statement-breakpoint
ALTER TABLE "developer_apps" DROP COLUMN IF EXISTS "discovery_excluded_capabilities";
