...
#   LIVEPEER_IMAGE=livepeer/go-livepeer:sha-469cf754a259b34927f8dc8d634da3b005493076 ./scripts/build-local-signer.sh
#
...
LIVEPEER_IMAGE="${LIVEPEER_IMAGE:-livepeer/go-livepeer:sha-469cf754a259b34927f8dc8d634da3b005493076}"
