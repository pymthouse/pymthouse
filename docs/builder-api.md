...
**Balance (Builder M2M):** `GET /api/v1/apps/{clientId}/usage/balance?externalUserId=...` (or `/api/v1/builder/apps/...`) is the confidential-client equivalent when an end-user JWT is not available.
